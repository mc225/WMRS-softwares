...
%==========================================================================
    function SaveOriginalCallbacks()
        ...
        mOrigCallbacks.window_key_press_fcn     = get(hFig, 'KeyPressFcn');
        mOrigCallbacks.window_key_release_fcn   = get(hFig, 'KeyReleaseFcn');
...
%==========================================================================
    function SetOriginalCallbacks()
        ...
        set(hFig, ...
        	...
        	'KeyPressFcn',        mOrigCallbacks.window_key_press_fcn, ...
        	'KeyReleaseFcn',      mOrigCallbacks.window_key_release_fcn, ...
...
%==========================================================================
    function SetFigureCallbacks3D()
        ...
        set(hFig, ...
            ...
            'KeyPressFcn',        {@WindowKeyPressCallback3D}, ...
            'KeyReleaseFcn',      {@WindowKeyReleaseCallback3D});
    end
%--------------------------------------------------------------------------
...
%==========================================================================
    function WindowKeyPressCallback2D(src, evnt)      %#ok
        ...
        switch evnt.Key
            case {'0','end','escape'}
                ResetAxesToOrigView();
            case {'equal', 'add','pageup'}
                ZoomKeys('plus');
            case {'hyphen', 'subtract','pagedown'}
                ZoomKeys('minus');
            case 'leftarrow'
                DragKeys('left');
            case 'rightarrow'
